        ...
        <>
            <div className={styles.footerContainer}>
                <div className={styles.upperContainer}>
                    <div className={styles.footerMenu}>
                        <h2 className={styles.myName}>Built by Joonil Kim</h2>
                        ...
                        <div className={styles.contactContainer}>
                            ...
                            <a target='_blank' rel="noreferrer" href='https://github.com/hydralisk1' style={{marginLeft: '1rem'}}>
                                <svg className={styles.svg} aria-hidden="true" height="36" version="1.1" viewBox="0 0 16 16" width="36">
                            ...
                            <a target='_blank' href='https://www.linkedin.com/in/joonil-kim-hello' style={{marginLeft: '1rem'}}><i style={{fontSize: '40px', cursor: 'pointer'}} className="fa-brands fa-linkedin"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div className={styles.bottomContainer}>
                <ul className={styles.bottomMenu}>
                    <li style={{fontSize: '20px'}}>© 2023 Itzy inspired by <a style={{fontSize: '20px', color: 'rgb(209, 115, 67)', fontWeight: 600}} href='https://www.etsy.com' target='_blank'>Etsy</a></li>
                </ul>
            </div>
        </>
    )
