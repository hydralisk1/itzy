        ...
        <>
            ...
            <div className={styles.bottomContainer}>
                <ul className={styles.bottomMenu}>
                    <li style={{fontSize: '20px'}}>© 2023 Itzy inspired by <Link style={{fontSize: '20px', color: 'rgb(209, 115, 67)', fontWeight: 600}} to='https://www.etsy.com' target='_blank'>Etsy</Link></li>
                </ul>
            </div>
        </>
    )
